...
[Variables]
  ...
  [h]
    family = SCALAR
    order = FIRST
    initial_condition = 1.0035238396227e+03
  []
[]
...
[Functions]
  [tide]
    type = ParsedFunction
    value = '-1E-7*sin((t)*4*pi/24/3600) * 1001'
  []
...
[Materials]
  ...
  [permeability_leaky]
    ...
    permeability = '1e-11 0 0 0 1e-11 0 0 0 0'
    block = 1
  []
  [permeability_aquifer]
    type = PorousFlowPermeabilityConst
    permeability = '1.0E-10 0 0 0 1.0E-10 0 0 0 0' # converges nicely
    block = 2
  []
  [density]
