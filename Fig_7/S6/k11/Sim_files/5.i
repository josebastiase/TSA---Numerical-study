...
[Variables]
  ...
  [h]
    family = SCALAR
    order = FIRST
    initial_condition = 1.0105102220185e02
  []
[]
...
[Materials]
  ...
  [permeability_leaky]
    ...
    permeability = '3.1622776601683794e-12 0 0 0 3.1622776601683794e-12 0 0 0 0'
    block = 1
  []
  [permeability_aquifer]
    type = PorousFlowPermeabilityConst
    permeability = '1.0E-11 0 0 0 1.0E-11 0 0 0 0' # converges nicely
    block = 2
  []
  [density]
